...
const WeeksForecastContainer = (props) => {
      ...
      let week = [
        {
          day: 'понедельник',
          data: createArr(
            res.filter((day) => findDay(day, 'понедельник'))
          ),
        },
        {
          day: 'вторник',
          data: createArr(
            res.filter((day) => findDay(day, 'вторник'))
          ),
        },
        {
          day: 'среда',
        ...
        },
        {
          day: 'четверг',
          data: createArr(
            res.filter((day) => findDay(day, 'четверг'))
          ),
        },
        {
          day: 'пятница',
          data: createArr(
            res.filter((day) => findDay(day, 'пятница'))
          ),
        },
        {
          day: 'суббота',
          data: createArr(
            res.filter((day) => findDay(day, 'суббота'))
          ),
        },
        {
          day: 'воскресенье',
          data: createArr(
            res.filter((day) => findDay(day, 'воскресенье'))
          ),
        },
      ];
      setWeek(week);
  ...
  return <WeekForecast city={props.city} week={week} />;
};
